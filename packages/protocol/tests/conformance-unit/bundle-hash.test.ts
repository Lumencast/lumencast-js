...
// The canonical form itself is owned and tested by @lumencast/canonical
// (ADR 005 §3.5 / RC 6) — including the producer property of §3.1 bis. What is
// asserted here is that this package's public surface still exposes it and
// still delegates, not a second copy of its behaviour.
describe("canonicalize — re-exported from @lumencast/canonical", () => {
  ...
  it("hashes the serialized shape, not the in-memory one", () => {
